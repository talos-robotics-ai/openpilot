...
def generate_launch_description():
    ...
    imu_topic_name_arg = DeclareLaunchArgument(
        "imu_topic_name", default_value="/policypilot/imu", description="Topic name to listen for Imu input (for example '/imu')")
    ...
    mola_lo_pipeline_arg = DeclareLaunchArgument(
        "mola_lo_pipeline", default_value="/ros2_ws/src/policypilot/pipelines/lidar3d.yaml", description="The LiDAR-Odometry pipeline configuration YAML file defining the LO system. Absolute path, or relative to 'mola-cli-launchs/lidar_odometry_ros2.yaml'. Default is the 'lidar3d-default.yaml' system described in the IJRR 2025 paper.")
